...
apt install figlet
clear
figlet -f smslant Extrapolar -c
figlet -f smslant Anonymous24   
figlet -f term Doble Extrapolacion -c 
figlet -f term by. @An0nym0us24 -c    
figlet -f term ____________________________________ -c 
echo ""
figlet -f term telegram t.me/TeamAnonymous24 -c 
figlet -f term ____________________________________ -c
echo ""    
...
echo ""
figlet -f term creditos @An0nym0us24 -c
echo ""
